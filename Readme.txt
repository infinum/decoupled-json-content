...
* `djc_set_menu_positions` - set all of the available menu position on you page, and set the appropriate endpoint. Returns array.
...
* `djc_append_endpoints_list` - append data to default endpoints list to show on API's List setting page. Must be multidimensional array with title and url key.
